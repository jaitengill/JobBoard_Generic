...
define('SMTP_USER', 'me@jaiten.com');
define('SMTP_PASS', '7tc9ur9s');
define('SMTP_PORT', 465);
define('SMTP_SECURE', 'ssl');

// APPLICATION URL PATHS
define('BASE_URL','http://142.93.42.141/'); // always include the trailing slash at the end
...
global $stripe;
$stripe = array(
  "secret_key"      => "sk_test_QpJvhwKKgftdaEXlC8yPO452",
  "publishable_key" => "pk_test_YngjOGM6lZecwKYEKavkGAHq"
);
